...
export default function ContactPage() {
  return (
    <div>
          ...
          const inner = (
            <>
              ...
              <div className="flex-1">
                <p className="text-xs font-bold uppercase tracking-widest text-[#0094BB] transition-colors duration-300 group-hover:text-background">
                  {channel.label}
                </p>
              ...
              {channel.href && (
                <span className="text-xs font-bold uppercase tracking-widest text-[#0094BB] transition-colors duration-300 group-hover:text-background">
                  →
                </span>
              )}
            </>
          ...
          if (channel.href) {
            return (
              <a
                ...
                className="group flex items-center gap-5 border-b border-foreground/10 px-4 py-6 transition-colors duration-300 last:border-b-0 hover:bg-[#0094BB] hover:text-background md:px-8 md:py-8"
              >
      ...
      {/* ── WhatsApp CTA ─────────────────────────────────────── */}
      <section className="border-b-4 border-foreground bg-[#0094BB] text-background">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="border-2 border-foreground bg-muted p-6 md:border-4 md:p-8">
                <p className="mb-4 text-xs font-bold uppercase tracking-widest text-[#0094BB]">
              ...
              <div className="border-2 border-foreground bg-foreground p-6 text-background md:border-4 md:p-8">
                ...
                <div className="space-y-3">
                  <a
                    href="tel:+5492613691623"
                    className="block text-sm transition-colors duration-200 hover:text-[#0094BB]"
                  >
      ...
      <section className="border-b-4 border-foreground bg-muted pattern-grid py-16 md:py-20">
        <div className="container mx-auto px-4 text-center">
          <p className="mb-4 text-xs font-bold uppercase tracking-[0.3em] text-[#0094BB]">
            Portal de Clientes
          </p>
          ...
          <Link
            href="/login"
            className="mt-8 inline-flex items-center justify-center border-2 border-foreground bg-foreground px-10 py-4 text-sm font-bold uppercase tracking-wide text-background transition-colors duration-200 hover:border-[#0094BB] hover:bg-[#0094BB]"
          >
            Acceder al Portal
          </Link>
        </div>
