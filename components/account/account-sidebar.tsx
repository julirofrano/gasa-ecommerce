...
import { User, Package, Cylinder, FileText, Truck } from "lucide-react";
...
const navLinks = [
  ...
  { href: ROUTES.ACCOUNT_RETURNS, label: "Devoluciones", icon: Truck },
];
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "border-accent text-accent md:border-accent"
                  : "border-transparent text-foreground hover:border-foreground hover:text-accent",
              )}
            >
